...
|    CSS     |   8    |   320    |    45    |    40    |   9.7%   |
|  配置文件  |   5    |   180    |    25    |    20    |   5.5%   |
|  Markdown  |   2    |    45    |    0     |    10    |   1.4%   |
|    其他    |   2    |    20    |    5     |    5     |   0.6%   |
|  **总计**  | **74** | **3295** | **480**  | **430**  | **100%** |

_注：统计数据由 GitHub Actions 自动更新，最后更新于 2025-03-18_
_排除了 node_modules、.next、dist 目录和 package-lock.json、pnpm-lock.yaml、.gitignore、.dockerignore、README.md、README_en.md 文件_
